 ...
 * [dev.nucleusframework.window.tao.NucleusPlatformView.NsView]
...
internal object SampleSwiftUIBridge {
    ...
    private fun tryLoad(): Handles? =
        try {
            ...
            val stream =
                SampleSwiftUIBridge::class.java.getResourceAsStream(resourcePath)
    ...
    fun setCounter(
        ...
        handles!!.setCounterH.invoke(handle, value)
    }
    ...
    fun setHue(
        ...
        handles!!.setHueH.invoke(handle, hue)
    }

    fun release(handle: MemorySegment) {
        handles!!.releaseH.invoke(handle)
    }
}
