...
internal fun FocusRequesterScreen() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
                ...
                Box(
                    modifier =
                        Modifier
                            ...
                            .onFocusChanged { vFocusedA = it.isFocused }
                            .focusable(),
                ) {
                ...
                Box(
                    modifier =
                        Modifier
                            ...
                            .onFocusChanged { vFocusedB = it.isFocused }
                            .focusable(),
                ) {
                    Box(modifier = Modifier.padding(12.dp)) {
        ...
        Section(
            "onFocusChanged standalone",
            "Wraps a focusable child; the observed text updates without making the wrapper focusable.",
        ) {
            Box(
                modifier =
                    Modifier
