...
Java_dev_nucleusframework_autolaunch_windows_NativeAutoLaunchBridge_nativeIsPackaged(
...
Java_dev_nucleusframework_autolaunch_windows_NativeAutoLaunchBridge_nativeGetDiagnostic(
    JNIEnv *env, jclass clazz) {
    (void)clazz;
    std::lock_guard<std::mutex> lock(g_diagMutex);
...
Java_dev_nucleusframework_autolaunch_windows_NativeAutoLaunchBridge_nativeRegReadState(
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_nucleusframework_autolaunch_windows_NativeAutoLaunchBridge_nativeRegWriteRun(
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_nucleusframework_autolaunch_windows_NativeAutoLaunchBridge_nativeRegDeleteRun(
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_nucleusframework_autolaunch_windows_NativeAutoLaunchBridge_nativeMsixGetState(
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_nucleusframework_autolaunch_windows_NativeAutoLaunchBridge_nativeMsixRequestEnable(
    JNIEnv *env, jclass clazz, jstring jTaskId) {
    (void)clazz;
    std::wstring taskId = toWString(env, jTaskId);
    if (taskId.empty()) return -1;
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_nucleusframework_autolaunch_windows_NativeAutoLaunchBridge_nativeIsStartupActivation(
    JNIEnv *env, jclass clazz) {
    (void)env; (void)clazz;
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_nucleusframework_autolaunch_windows_NativeAutoLaunchBridge_nativeIsLaunchedByTaskScheduler(
    JNIEnv *env, jclass clazz) {
    (void)env; (void)clazz;
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_nucleusframework_autolaunch_windows_NativeAutoLaunchBridge_nativeMsixDisable(
    JNIEnv *env, jclass clazz, jstring jTaskId) {
    (void)clazz;
    std::wstring taskId = toWString(env, jTaskId);
    if (taskId.empty()) return -1;
