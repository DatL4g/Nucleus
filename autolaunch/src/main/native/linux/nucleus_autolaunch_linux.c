...
Java_dev_nucleusframework_autolaunch_linux_NativeAutoLaunchLinuxBridge_nativeIsPortalAvailable(
...
Java_dev_nucleusframework_autolaunch_linux_NativeAutoLaunchLinuxBridge_nativeRequestBackground(
    JNIEnv *env, jclass clazz,
    jboolean enable,
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_autolaunch_linux_NativeAutoLaunchLinuxBridge_nativeWriteUnitFile(
    JNIEnv *env, jclass clazz,
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_autolaunch_linux_NativeAutoLaunchLinuxBridge_nativeDeleteUnitFile(
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_autolaunch_linux_NativeAutoLaunchLinuxBridge_nativeEnableUnit(
    JNIEnv *env, jclass clazz, jstring j_unit_name)
{
    (void)clazz;
    GDBusConnection *conn = get_connection();
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_autolaunch_linux_NativeAutoLaunchLinuxBridge_nativeDisableUnit(
    JNIEnv *env, jclass clazz, jstring j_unit_name)
{
    (void)clazz;
    GDBusConnection *conn = get_connection();
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_autolaunch_linux_NativeAutoLaunchLinuxBridge_nativeGetUnitFileState(
    JNIEnv *env, jclass clazz, jstring j_unit_name)
{
    (void)clazz;
    GDBusConnection *conn = get_connection();
...
Java_dev_nucleusframework_autolaunch_linux_NativeAutoLaunchLinuxBridge_nativeGetDiagnostic(
    JNIEnv *env, jclass clazz)
{
    (void)clazz;
    pthread_mutex_lock(&g_diag_mutex);
