...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessCount(
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessPids(
    JNIEnv *env, jclass clazz) {
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessNames(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessExes(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessMemories(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_proc_count);
    jlong *vals = (jlong *)malloc(g_proc_count * sizeof(jlong));
    if (!vals) return arr;
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessVirtualMemories(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_proc_count);
    jlong *vals = (jlong *)malloc(g_proc_count * sizeof(jlong));
    if (!vals) return arr;
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessCpuUsages(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessStatuses(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessStartTimes(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_proc_count);
    jlong *vals = (jlong *)malloc(g_proc_count * sizeof(jlong));
    if (!vals) return arr;
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessRunTimes(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_proc_count);
    jlong *vals = (jlong *)malloc(g_proc_count * sizeof(jlong));
    if (!vals) return arr;
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessParentPids(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_proc_count);
    jlong *vals = (jlong *)malloc(g_proc_count * sizeof(jlong));
    if (!vals) return arr;
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessCmds(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessCwds(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProcessRoots(
    JNIEnv *env, jclass clazz) {
