...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryPresent(
...
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryExternalConnected(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
...
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryIsCharging(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
    if (!bat->valid) return JNI_FALSE;
...
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryFullyCharged(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
    if (!bat->valid) return JNI_FALSE;
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryCurrentCapacity(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryMaxCapacity(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
    if (!bat->valid) return 0;
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryDesignCapacity(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
    if (!bat->valid) return 0;
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryCycleCount(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
    if (!bat->valid) return 0;
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryVoltage(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
    if (!bat->valid) return 0;
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryAmperage(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
    if (!bat->valid) return 0;
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryTemperature(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryTimeRemaining(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryManufacturer(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatteryModelName(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
    if (!bat->valid) return NULL;
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBatterySerialNumber(
    JNIEnv *env, jclass clazz) {
    BatteryData *bat = get_battery();
    if (!bat->valid) return NULL;
