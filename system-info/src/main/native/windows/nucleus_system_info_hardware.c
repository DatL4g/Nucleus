...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeMotherboardName(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeMotherboardVendor(
    JNIEnv *env, jclass clazz) {
    BYTE len;
    const BYTE *s = find_smbios_struct(2, &len);
    if (!s || len < 8) return NULL;
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeMotherboardVersion(
    JNIEnv *env, jclass clazz) {
    BYTE len;
    const BYTE *s = find_smbios_struct(2, &len);
    if (!s || len < 8) return NULL;
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeMotherboardSerial(
    JNIEnv *env, jclass clazz) {
    BYTE len;
    const BYTE *s = find_smbios_struct(2, &len);
    if (!s || len < 8) return NULL;
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeMotherboardAssetTag(
    JNIEnv *env, jclass clazz) {
    BYTE len;
    const BYTE *s = find_smbios_struct(2, &len);
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProductName(
    JNIEnv *env, jclass clazz) {
    BYTE len;
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProductFamily(
    JNIEnv *env, jclass clazz) {
    BYTE len;
    const BYTE *s = find_smbios_struct(1, &len);
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProductSerial(
    JNIEnv *env, jclass clazz) {
    BYTE len;
    const BYTE *s = find_smbios_struct(1, &len);
    if (!s || len < 8) return NULL;
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProductSku(
    JNIEnv *env, jclass clazz) {
    BYTE len;
    const BYTE *s = find_smbios_struct(1, &len);
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProductUuid(
    JNIEnv *env, jclass clazz) {
    BYTE len;
    const BYTE *s = find_smbios_struct(1, &len);
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProductVersion(
    JNIEnv *env, jclass clazz) {
    BYTE len;
    const BYTE *s = find_smbios_struct(1, &len);
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeProductVendor(
    JNIEnv *env, jclass clazz) {
    BYTE len;
    const BYTE *s = find_smbios_struct(1, &len);
