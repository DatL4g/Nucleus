...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuCount(
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuNames(
    JNIEnv *env, jclass clazz) {
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuVendorIds(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuDeviceIds(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_gpu_count);
    jlong *vals = (jlong *)malloc(g_gpu_count * sizeof(jlong));
    if (!vals) return arr;
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuDedicatedVideoMemories(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_gpu_count);
    jlong *vals = (jlong *)malloc(g_gpu_count * sizeof(jlong));
    if (!vals) return arr;
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuDedicatedSystemMemories(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_gpu_count);
    jlong *vals = (jlong *)malloc(g_gpu_count * sizeof(jlong));
    if (!vals) return arr;
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuSharedSystemMemories(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_gpu_count);
    jlong *vals = (jlong *)malloc(g_gpu_count * sizeof(jlong));
    if (!vals) return arr;
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuDriverVersions(
    JNIEnv *env, jclass clazz) {
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuTemperatures(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jfloatArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuUsages(
    JNIEnv *env, jclass clazz) {
    jfloatArray arr = (*env)->NewFloatArray(env, g_gpu_count);
    jfloat *vals = (jfloat *)malloc(g_gpu_count * sizeof(jfloat));
    if (!vals) return arr;
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuMemoryUsed(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_gpu_count);
    jlong *vals = (jlong *)malloc(g_gpu_count * sizeof(jlong));
    if (!vals) return arr;
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuCoreClocks(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jintArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuMemoryClocks(
    JNIEnv *env, jclass clazz) {
    jintArray arr = (*env)->NewIntArray(env, g_gpu_count);
    jint *vals = (jint *)malloc(g_gpu_count * sizeof(jint));
    if (!vals) return arr;
...
JNIEXPORT jfloatArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuFanSpeeds(
    JNIEnv *env, jclass clazz) {
    jfloatArray arr = (*env)->NewFloatArray(env, g_gpu_count);
    jfloat *vals = (jfloat *)malloc(g_gpu_count * sizeof(jfloat));
    if (!vals) return arr;
...
JNIEXPORT jfloatArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGpuPowerDraws(
    JNIEnv *env, jclass clazz) {
    jfloatArray arr = (*env)->NewFloatArray(env, g_gpu_count);
    jfloat *vals = (jfloat *)malloc(g_gpu_count * sizeof(jfloat));
    if (!vals) return arr;
