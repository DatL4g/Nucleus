...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeIsNetworkConnected(
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeGetMeteredStatus(
    JNIEnv *env, jclass clazz) {
