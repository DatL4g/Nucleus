...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeNetworkCount(
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeNetworkNames(
    JNIEnv *env, jclass clazz) {
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeNetworkReceivedBytes(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeNetworkTransmittedBytes(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_net_count);
    jlong *vals = (jlong *)malloc(g_net_count * sizeof(jlong));
    if (!vals) return arr;
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeNetworkReceivedPackets(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_net_count);
    jlong *vals = (jlong *)malloc(g_net_count * sizeof(jlong));
    if (!vals) return arr;
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeNetworkTransmittedPackets(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_net_count);
    jlong *vals = (jlong *)malloc(g_net_count * sizeof(jlong));
    if (!vals) return arr;
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeNetworkErrorsReceived(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_net_count);
    jlong *vals = (jlong *)malloc(g_net_count * sizeof(jlong));
    if (!vals) return arr;
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeNetworkErrorsTransmitted(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_net_count);
    jlong *vals = (jlong *)malloc(g_net_count * sizeof(jlong));
    if (!vals) return arr;
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeNetworkMacAddresses(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeNetworkMtus(
    JNIEnv *env, jclass clazz) {
    jlongArray arr = (*env)->NewLongArray(env, g_net_count);
    jlong *vals = (jlong *)malloc(g_net_count * sizeof(jlong));
    if (!vals) return arr;
