...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeUserCount(
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeUserNames(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeUserIds(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeUserGroupIds(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeUserGroups(
    JNIEnv *env, jclass clazz) {
