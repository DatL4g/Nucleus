...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeTotalMemory(
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeFreeMemory(
    JNIEnv *env, jclass clazz) {
    MEMORYSTATUSEX ms;
    if (!get_mem_status(&ms)) return 0;
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeAvailableMemory(
    JNIEnv *env, jclass clazz) {
    MEMORYSTATUSEX ms;
    if (!get_mem_status(&ms)) return 0;
    return (jlong)ms.ullAvailPhys;
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeUsedMemory(
    JNIEnv *env, jclass clazz) {
    MEMORYSTATUSEX ms;
    if (!get_mem_status(&ms)) return 0;
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeTotalSwap(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeFreeSwap(
    JNIEnv *env, jclass clazz) {
    PERFORMANCE_INFORMATION pi;
    pi.cb = sizeof(pi);
    if (!K32GetPerformanceInfo(&pi, sizeof(pi))) return 0;
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeUsedSwap(
    JNIEnv *env, jclass clazz) {
    PERFORMANCE_INFORMATION pi;
    pi.cb = sizeof(pi);
    if (!K32GetPerformanceInfo(&pi, sizeof(pi))) return 0;
