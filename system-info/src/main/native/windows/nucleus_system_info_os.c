...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeOsName(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeKernelVersion(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeOsVersion(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeLongOsVersion(
    JNIEnv *env, jclass clazz) {
    char *product = reg_read_string(HKEY_LOCAL_MACHINE, NT_CURRENT_VERSION, L"ProductName");
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeDistributionId(
    JNIEnv *env, jclass clazz) {
    return to_jstring(env, "windows");
}

JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeHostName(
    JNIEnv *env, jclass clazz) {
    wchar_t buf[256];
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeCpuArch(
    JNIEnv *env, jclass clazz) {
    SYSTEM_INFO si;
...
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeUptime(
    JNIEnv *env, jclass clazz) {
    return (jlong)(GetTickCount64() / 1000ULL);
}

JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_windows_NativeWindowsSystemInfoBridge_nativeBootTime(
    JNIEnv *env, jclass clazz) {
