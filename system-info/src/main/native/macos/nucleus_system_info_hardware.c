...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeMotherboardName(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeMotherboardVendor(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeMotherboardVersion(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeMotherboardSerial(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeMotherboardAssetTag(
    JNIEnv *env, jclass clazz) {
...
// Product
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeProductName(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeProductFamily(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeProductSerial(
    JNIEnv *env, jclass clazz) {
    char *val = read_platform_property("IOPlatformSerialNumber");
    if (!val) return NULL;
    jstring result = to_jstring(env, val);
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeProductSku(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeProductUuid(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeProductVersion(
    JNIEnv *env, jclass clazz) {
    char *val = sysctl_string("hw.model");
    if (!val) return NULL;
    jstring result = to_jstring(env, val);
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeProductVendor(
    JNIEnv *env, jclass clazz) {
    char *val = read_platform_property("manufacturer");
    if (!val) return to_jstring(env, "Apple Inc.");
    jstring result = to_jstring(env, val);
