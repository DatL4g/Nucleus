...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeOsName(
    JNIEnv *env, jclass clazz) {
    return to_jstring(env, "macOS");
}

JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeKernelVersion(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeOsVersion(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeLongOsVersion(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeDistributionId(
    JNIEnv *env, jclass clazz) {
    return to_jstring(env, "macos");
}

JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeHostName(
    JNIEnv *env, jclass clazz) {
    char buf[256];
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeCpuArch(
    JNIEnv *env, jclass clazz) {
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeUptime(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBootTime(
    JNIEnv *env, jclass clazz) {
