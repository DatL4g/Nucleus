...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeComponentCount(
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeComponentLabels(
    JNIEnv *env, jclass clazz) {
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeComponentTemperatures(
    JNIEnv *env, jclass clazz) {
    if (g_component_count <= 0) return NULL;
...
JNIEXPORT jfloatArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeComponentMaxTemperatures(
    JNIEnv *env, jclass clazz) {
    if (g_component_count <= 0) return NULL;
    jfloat *vals = (jfloat *)malloc(g_component_count * sizeof(jfloat));
...
JNIEXPORT jfloatArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeComponentCriticalTemperatures(
    JNIEnv *env, jclass clazz) {
    if (g_component_count <= 0) return NULL;
    jfloat *vals = (jfloat *)malloc(g_component_count * sizeof(jfloat));
