...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryPresent(
...
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryExternalConnected(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
    if (!props) return JNI_FALSE;
...
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryIsCharging(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
    if (!props) return JNI_FALSE;
...
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryFullyCharged(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
    if (!props) return JNI_FALSE;
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryCurrentCapacity(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
    if (!props) return 0;
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryMaxCapacity(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
    if (!props) return 0;
    jint result = get_raw_or_standard_capacity(props,
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryDesignCapacity(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
    if (!props) return 0;
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryCycleCount(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
    if (!props) return 0;
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryVoltage(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
    if (!props) return 0;
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryAmperage(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
    if (!props) return 0;
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryTemperature(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryTimeRemaining(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
    if (!props) return -1;
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryManufacturer(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatteryModelName(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
    if (!props) return NULL;
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeBatterySerialNumber(
    JNIEnv *env, jclass clazz) {
    CFDictionaryRef props = copy_battery_properties();
    if (!props) return NULL;
