...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuCount(
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuNames(
    JNIEnv *env, jclass clazz) {
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuVendorIds(
    JNIEnv *env, jclass clazz) {
    if (g_gpu_count <= 0) return NULL;
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuDeviceIds(
    JNIEnv *env, jclass clazz) {
    if (g_gpu_count <= 0) return NULL;
    jlong *vals = (jlong *)malloc(g_gpu_count * sizeof(jlong));
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuDedicatedVideoMemories(
    JNIEnv *env, jclass clazz) {
    if (g_gpu_count <= 0) return NULL;
    jlong *vals = (jlong *)malloc(g_gpu_count * sizeof(jlong));
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuDedicatedSystemMemories(
    JNIEnv *env, jclass clazz) {
    if (g_gpu_count <= 0) return NULL;
    jlong *vals = (jlong *)malloc(g_gpu_count * sizeof(jlong));
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuSharedSystemMemories(
    JNIEnv *env, jclass clazz) {
    if (g_gpu_count <= 0) return NULL;
    jlong *vals = (jlong *)malloc(g_gpu_count * sizeof(jlong));
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuDriverVersions(
    JNIEnv *env, jclass clazz) {
    if (g_gpu_count <= 0) return NULL;
    const char **arr = (const char **)malloc(g_gpu_count * sizeof(char *));
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuTemperatures(
    JNIEnv *env, jclass clazz) {
    if (g_gpu_count <= 0) return NULL;
...
JNIEXPORT jfloatArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuUsages(
    JNIEnv *env, jclass clazz) {
    if (g_gpu_count <= 0) return NULL;
    jfloat *vals = (jfloat *)malloc(g_gpu_count * sizeof(jfloat));
...
JNIEXPORT jlongArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuMemoryUsed(
    JNIEnv *env, jclass clazz) {
    if (g_gpu_count <= 0) return NULL;
    jlong *vals = (jlong *)malloc(g_gpu_count * sizeof(jlong));
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuCoreClocks(
    JNIEnv *env, jclass clazz) {
    if (g_gpu_count <= 0) return NULL;
...
JNIEXPORT jintArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuMemoryClocks(
    JNIEnv *env, jclass clazz) {
    if (g_gpu_count <= 0) return NULL;
    jint *vals = (jint *)malloc(g_gpu_count * sizeof(jint));
...
JNIEXPORT jfloatArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuFanSpeeds(
    JNIEnv *env, jclass clazz) {
    if (g_gpu_count <= 0) return NULL;
    jfloat *vals = (jfloat *)malloc(g_gpu_count * sizeof(jfloat));
...
JNIEXPORT jfloatArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGpuPowerDraws(
    JNIEnv *env, jclass clazz) {
    if (g_gpu_count <= 0) return NULL;
    jfloat *vals = (jfloat *)malloc(g_gpu_count * sizeof(jfloat));
