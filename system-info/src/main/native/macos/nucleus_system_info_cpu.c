...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGlobalCpuUsage(
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativePhysicalCoreCount(
    JNIEnv *env, jclass clazz) {
    int32_t count = 0;
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeCpuCount(
    JNIEnv *env, jclass clazz) {
    return (jint)count_logical_cpus();
}

JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeCpuNames(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeCpuVendorIds(
    JNIEnv *env, jclass clazz) {
    int count = count_logical_cpus();
    if (count <= 0 || count > MAX_CPUS) return NULL;
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeCpuBrands(
    JNIEnv *env, jclass clazz) {
    int count = count_logical_cpus();
    if (count <= 0 || count > MAX_CPUS) return NULL;
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeCpuFrequencies(
    JNIEnv *env, jclass clazz) {
    int count = count_logical_cpus();
    if (count <= 0 || count > MAX_CPUS) return NULL;
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeCpuUsages(
    JNIEnv *env, jclass clazz) {
    int count = count_logical_cpus();
    if (count <= 0 || count > MAX_CPUS) return NULL;
