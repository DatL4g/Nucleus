...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeIsNetworkConnected(
...
Java_dev_nucleusframework_systeminfo_macos_NativeMacOsSystemInfoBridge_nativeGetMeteredStatus(
    JNIEnv *env, jclass clazz) {
