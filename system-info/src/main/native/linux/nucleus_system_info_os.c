...
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeOsName(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeKernelVersion(
    JNIEnv *env, jclass clazz) {
    struct utsname info;
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeOsVersion(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeLongOsVersion(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeDistributionId(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeHostName(
    JNIEnv *env, jclass clazz) {
    char buf[256];
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeCpuArch(
    JNIEnv *env, jclass clazz) {
    struct utsname info;
    if (uname(&info) != 0) return NULL;
...
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeUptime(
    JNIEnv *env, jclass clazz) {
    struct sysinfo si;
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeBootTime(
    JNIEnv *env, jclass clazz) {
    struct sysinfo si;
    if (sysinfo(&si) != 0) return 0;
