...
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeTotalMemory(
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeFreeMemory(
    JNIEnv *env, jclass clazz) {
    meminfo_t mi;
    if (read_meminfo(&mi) != 0) return 0;
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeAvailableMemory(
    JNIEnv *env, jclass clazz) {
    meminfo_t mi;
    if (read_meminfo(&mi) != 0) return 0;
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeUsedMemory(
    JNIEnv *env, jclass clazz) {
    meminfo_t mi;
    if (read_meminfo(&mi) != 0) return 0;
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeTotalSwap(
    JNIEnv *env, jclass clazz) {
    meminfo_t mi;
    if (read_meminfo(&mi) != 0) return 0;
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeFreeSwap(
    JNIEnv *env, jclass clazz) {
    meminfo_t mi;
    if (read_meminfo(&mi) != 0) return 0;
...
JNIEXPORT jlong JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeUsedSwap(
    JNIEnv *env, jclass clazz) {
    meminfo_t mi;
    if (read_meminfo(&mi) != 0) return 0;
