...
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeUserCount(
...
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeUserNames(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeUserIds(
    JNIEnv *env, jclass clazz) {
    if (g_user_count <= 0) return NULL;
    const char **arr = (const char **)malloc(g_user_count * sizeof(char *));
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeUserGroupIds(
    JNIEnv *env, jclass clazz) {
    if (g_user_count <= 0) return NULL;
    const char **arr = (const char **)malloc(g_user_count * sizeof(char *));
...
JNIEXPORT jobjectArray JNICALL
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeUserGroups(
    JNIEnv *env, jclass clazz) {
    if (g_user_count <= 0) return NULL;
    const char **arr = (const char **)malloc(g_user_count * sizeof(char *));
