...
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeProcessCount(
...
Java_dev_nucleusframework_systeminfo_linux_NativeLinuxSystemInfoBridge_nativeProcessCpuUsages(
    JNIEnv *env, jclass clazz) {
    if (g_proc_count <= 0) return NULL;
