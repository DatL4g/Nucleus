...
Java_dev_nucleusframework_window_utils_windows_JniWindowsDecorationBridge_nativeInstallDecoration(
...
/* -------------------------------------------------------------- */
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_utils_windows_JniWindowsDecorationBridge_nativeUninstallDecoration(
...
/* -------------------------------------------------------------- */
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_utils_windows_JniWindowsDecorationBridge_nativeSetForceHitTestClient(
...
/* -------------------------------------------------------------- */
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_utils_windows_JniWindowsDecorationBridge_nativeSetTitleBarHeight(
...
/* -------------------------------------------------------------- */
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_utils_windows_JniWindowsDecorationBridge_nativeStartDrag(
    JNIEnv *env, jclass clazz, jlong hwndLong)
{
    HWND hwnd = (HWND)(uintptr_t)hwndLong;
    if (!hwnd || !IsWindow(hwnd)) return;
...
Java_dev_nucleusframework_window_utils_windows_JniWindowsDecorationBridge_nativeGetHwnd(
...
/* -------------------------------------------------------------- */
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_utils_windows_JniWindowsDecorationBridge_nativeApplyDialogStyle(
    JNIEnv *env, jclass clazz, jlong hwndLong)
{
    HWND hwnd = (HWND)(uintptr_t)hwndLong;
    if (!hwnd || !IsWindow(hwnd)) return;
...
/* -------------------------------------------------------------- */
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_utils_windows_JniWindowsDecorationBridge_nativeSetFullscreen(
...
Java_dev_nucleusframework_window_utils_windows_JniWindowsDecorationBridge_nativeIsFullscreen(
    JNIEnv *env, jclass clazz, jlong hwndLong)
{
    HWND hwnd = (HWND)(uintptr_t)hwndLong;
...
/* -------------------------------------------------------------- */
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_utils_windows_JniWindowsDecorationBridge_nativeSetBackgroundColor(
...
Java_dev_nucleusframework_window_utils_windows_JniWindowsDecorationBridge_nativeGetDebugInfo(
    JNIEnv *env, jclass clazz, jlong hwndLong)
{
    HWND hwnd = (HWND)(uintptr_t)hwndLong;
...
/* -------------------------------------------------------------- */
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_utils_windows_JniWindowsDecorationBridge_nativeSetMinimumSize(
...
/* -------------------------------------------------------------- */
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_utils_windows_JniWindowsDecorationBridge_nativeSetMaximumSize(
    JNIEnv *env, jclass clazz, jlong hwndLong, jint widthPx, jint heightPx)
{
    HWND hwnd = (HWND)(uintptr_t)hwndLong;
    if (!hwnd) return;
