...
Java_dev_nucleusframework_window_utils_linux_JniLinuxWindowBridge_nativeStartWindowMove(
...
/* ------------------------------------------------------------------ */
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_window_utils_linux_JniLinuxWindowBridge_nativeSetFullscreen(
...
/* ------------------------------------------------------------------ */
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_window_utils_linux_JniLinuxWindowBridge_nativeIsFullscreen(
...
/* ------------------------------------------------------------------ */
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_window_utils_linux_JniLinuxWindowBridge_nativeIsWmMoveResizeSupported(
    JNIEnv *env, jclass clazz, jobject awtWindow)
{
    Display *display = getAwtDisplay(env);
    if (!display) return JNI_FALSE;
