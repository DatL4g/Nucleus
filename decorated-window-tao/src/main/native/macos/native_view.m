...
Java_dev_nucleusframework_window_tao_NativeTaoMacOsNativeViewBridge_nativeAddSubview(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_tao_NativeTaoMacOsNativeViewBridge_nativeRemoveSubview(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_tao_NativeTaoMacOsNativeViewBridge_nativeSetSubviewFrame(
 ...
 */
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_tao_NativeTaoMacOsNativeViewBridge_nativeSetSubviewCornerRadius(
...
Java_dev_nucleusframework_window_tao_NativeTaoMacOsNativeViewBridge_nativeCreateOverlay(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_tao_NativeTaoMacOsNativeViewBridge_nativeSetOverlayFrame(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_tao_NativeTaoMacOsNativeViewBridge_nativeSetOverlayCallback(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_tao_NativeTaoMacOsNativeViewBridge_nativeSetOverlayRegions(
...
Java_dev_nucleusframework_window_tao_NativeTaoMacOsNativeViewBridge_nativeIsFirstResponder(
    JNIEnv *env, jclass clazz, jlong overlayPtr)
{
    (void)env; (void)clazz;
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_tao_NativeTaoMacOsNativeViewBridge_nativeReleaseOverlay(
    JNIEnv *env, jclass clazz, jlong overlayPtr)
{
    (void)clazz;
    if (overlayPtr == 0) return;
