...
#[no_mangle]
pub extern "system" fn Java_dev_nucleusframework_window_tao_NativeTaoBridge_nativeAttachTextOverlay(
    _env: JNIEnv,
    _class: JClass,
    handle: jlong,
) {
...
#[no_mangle]
pub extern "system" fn Java_dev_nucleusframework_window_tao_NativeTaoBridge_nativeFocusTextOverlay(
    _env: JNIEnv,
    _class: JClass,
    focused: jboolean,
) {
