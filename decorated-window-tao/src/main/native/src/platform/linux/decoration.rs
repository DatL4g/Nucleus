...
#[no_mangle]
pub extern "system" fn Java_dev_nucleusframework_window_tao_NativeTaoBridge_nativeLinuxSetDialogOwner(
    _env: JNIEnv,
    _class: JClass,
    child_handle: jlong,
    owner_handle: jlong,
...
#[no_mangle]
pub extern "system" fn Java_dev_nucleusframework_window_tao_NativeTaoBridge_nativeLinuxGetWindowRect(
    env: JNIEnv,
    _class: JClass,
    handle: jlong,
) -> jlongArray {
