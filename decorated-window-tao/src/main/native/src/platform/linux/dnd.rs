...
#[no_mangle]
pub extern "system" fn Java_dev_nucleusframework_window_tao_NativeTaoLinuxDndBridge_nativeRegister(
    env: JNIEnv,
    _class: JClass,
    handle: jlong,
    callback: JObject,
...
#[no_mangle]
pub extern "system" fn Java_dev_nucleusframework_window_tao_NativeTaoLinuxDndBridge_nativeRevoke(
    _env: JNIEnv,
    _class: JClass,
    handle: jlong,
) -> jint {
...
#[no_mangle]
#[allow(unused_mut)]
pub extern "system" fn Java_dev_nucleusframework_window_tao_NativeTaoLinuxDndBridge_nativeStartDrag(
    mut env: JNIEnv,
    _class: JClass,
    handle: jlong,
    files: JObjectArray,
