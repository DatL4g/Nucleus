...
#[no_mangle]
pub extern "system" fn Java_dev_nucleusframework_window_tao_NativeTaoBridge_nativeLinuxHandles(
    env: JNIEnv,
    _class: JClass,
    handle: jlong,
) -> jlongArray {
...
#[no_mangle]
pub extern "system" fn Java_dev_nucleusframework_window_tao_NativeTaoBridge_nativeLinuxGtkWindow(
    _env: JNIEnv,
    _class: JClass,
    handle: jlong,
) -> jlong {
