...
#[no_mangle]
pub extern "system" fn Java_dev_nucleusframework_window_tao_NativeTaoLinuxTouchBridge_nativeRegister(
    env: JNIEnv,
    _class: JClass,
    handle: jlong,
    callback: JObject,
...
#[no_mangle]
pub extern "system" fn Java_dev_nucleusframework_window_tao_NativeTaoLinuxTouchBridge_nativeRevoke(
    _env: JNIEnv,
    _class: JClass,
    handle: jlong,
) -> jint {
