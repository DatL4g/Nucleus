...
#[no_mangle]
pub extern "system" fn Java_dev_nucleusframework_window_tao_NativeTaoBridge_nativeLinuxPrimaryMonitorWorkArea(
    env: JNIEnv,
    _class: JClass,
    handle: jlong,
) -> jlongArray {
...
#[no_mangle]
pub extern "system" fn Java_dev_nucleusframework_window_tao_NativeTaoBridge_nativeLinuxPrimaryMonitorScaleMilli(
    _env: JNIEnv,
    _class: JClass,
    handle: jlong,
) -> jint {
