...
Java_dev_nucleusframework_window_tao_NativeTaoWindowsNativeViewBridge_nativeAttach(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_tao_NativeTaoWindowsNativeViewBridge_nativeDetach(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_tao_NativeTaoWindowsNativeViewBridge_nativeSetFrame(
    JNIEnv *env, jclass clazz, jlong parentHwnd, jlong childHwnd,
...
Java_dev_nucleusframework_window_tao_NativeTaoWindowsNativeViewBridge_nativeIsFocusInTree(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_window_tao_NativeTaoWindowsNativeViewBridge_nativeSetCornerRadius(
