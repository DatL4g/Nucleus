...
Java_dev_nucleusframework_window_tao_NativeTaoWindowsDndBridge_nativeRegister(
 ...
 */
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_window_tao_NativeTaoWindowsDndBridge_nativeRevoke(
...
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_window_tao_NativeTaoWindowsDndBridge_nativeStartDrag(
