...
internal class MacOsSampleWebViewController(
...
internal class LinuxSampleWebViewController(
    override val handle: Long,
) : SampleWebViewController {
...
internal class WindowsSampleWebViewController(
    override val handle: Long,
) : SampleWebViewController {
...
internal fun isSampleWebViewSupported(): Boolean =
