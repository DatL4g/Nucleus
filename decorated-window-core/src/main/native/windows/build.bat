@echo off
REM Compiles nucleus_layout_direction_windows.c into per-architecture DLLs (x64 + ARM64).

setlocal enabledelayedexpansion

set "SCRIPT_DIR=%~dp0"
set "SRC=%SCRIPT_DIR%nucleus_layout_direction_windows.c"
...
echo.
echo Built DLLs:
if exist "%OUT_DIR_X64%\nucleus_layout_direction.dll" echo   %OUT_DIR_X64%\nucleus_layout_direction.dll
if exist "%OUT_DIR_ARM64%\nucleus_layout_direction.dll" echo   %OUT_DIR_ARM64%\nucleus_layout_direction.dll
