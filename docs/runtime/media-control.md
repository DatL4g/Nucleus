...
```proguard
-keep class dev.nucleusframework.media.control.linux.NativeLinuxBridge {
    native <methods>;
    static ** on*(...);
}
-keep class dev.nucleusframework.media.control.macos.NativeMacOsBridge {
    native <methods>;
    static ** on*(...);
}
-keep class dev.nucleusframework.media.control.windows.NativeWindowsBridge {
    native <methods>;
    static ** on*(...);
}
```
