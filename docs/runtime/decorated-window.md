...
-keep class dev.nucleusframework.window.utils.macos.JniMacTitleBarBridge {
    native <methods>;
}
-keep class dev.nucleusframework.window.utils.windows.JniWindowsDecorationBridge {
    native <methods>;
}
-keep class dev.nucleusframework.window.utils.linux.JniLinuxWindowBridge {
    native <methods>;
}
