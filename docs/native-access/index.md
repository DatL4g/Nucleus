...
plugins {
    ...
    id("dev.nucleusframeworknativeaccess") version "<version>" // see github.com/NucleusFramework/NucleusNativeAccess
}
...
plugins {
    kotlin("multiplatform")
    id("dev.nucleusframeworknativeaccess") version "<version>"
}
...
The plugin ID is `dev.nucleusframeworknativeaccess`.
