...
Java_dev_nucleusframework_launcher_linux_NativeLinuxLauncherBridge_nativeUpdate(
...
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_launcher_linux_NativeLinuxLauncherBridge_nativeRegisterQueryHandler(
...
Java_dev_nucleusframework_launcher_linux_NativeLinuxLauncherBridge_nativeSetState(
    JNIEnv *env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_launcher_linux_NativeLinuxLauncherBridge_nativeUnregister(
    JNIEnv *env, jclass clazz)
{
    (void)env; (void)clazz;
    pthread_mutex_lock(&g_state_mutex);
...
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_launcher_linux_NativeLinuxLauncherBridge_nativeSetMenu(
    JNIEnv *env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_launcher_linux_NativeLinuxLauncherBridge_nativeDestroyMenu(
