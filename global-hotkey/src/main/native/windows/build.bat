@echo off
REM Compiles nucleus_global_hotkey.cpp into per-architecture DLLs (x64 + ARM64).
...
set "SCRIPT_DIR=%~dp0"
set "SRC=%SCRIPT_DIR%nucleus_global_hotkey.cpp"
...
echo.
echo Built DLLs:
if exist "%OUT_DIR_X64%\nucleus_global_hotkey.dll" echo   %OUT_DIR_X64%\nucleus_global_hotkey.dll
if exist "%OUT_DIR_ARM64%\nucleus_global_hotkey.dll" echo   %OUT_DIR_ARM64%\nucleus_global_hotkey.dll
